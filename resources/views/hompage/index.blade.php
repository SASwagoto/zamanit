...
<div class="flex justify-center items-center mt-5">
    <form action="{{route('search')}}" class="w-full flex justify-center items-center" method="GET">
        <div class="w-1/3 flex relative">
            <input type="text" class="w-full py-4 px-5 rounded-full border border-gray hover:drop-shadow-md focus:outline-none focus:drop-shadow-md" placeholder="Search" name="keyword">
